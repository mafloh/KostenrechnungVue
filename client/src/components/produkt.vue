<template>
  <div>
    <li>
      ...
      >{{ produkt.name }} : {{ this.$store.getters.wartungsvertraege[0][produkt.name] + this.$store.getters.extraEinnahmen[0][produkt.name] - (this.$store.getters.personal[0][produkt.name] * 1.13)}}</h3>
